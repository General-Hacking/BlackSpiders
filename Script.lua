...
if not msg.Director then
return "𖤐 ** هذا الامر يخص {المدير,المنشئ} فقط  \n"
end
redis:set(hack.."getidstatus"..msg.chat_id_, "Photo")
return  "𖤐 ** أهلا عزيزي "..msg.TheRankCmd.."\n𖤐 ** تم تفعيل الايدي بالصوره \n" 
end
function cmds_on(msg)
if not msg.Creator then return "𖤐 ** هذا الامر يخص {المنشئ} فقط  \n"
end
...
if not msg.Admin then return "𖤐 *│* هذا الامر يخص {الادمن,المدير,المنشئ} فقط  \n"
end
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {GENERAL} فقط  \n💥" end
...
if not msg.SudoUser then return "𖤐 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if MsgText[1] == 'وضع كليشه' then
return redis:get(hack..":TEXT_SUDO") or '𖤐 لا توجد كليشه  .\n𖤐 يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه ` " \n'
end
...
if not msg.SudoUser then return"𖤐 **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(hack..'lock_brod') then 
return "𖤐 ** الاذاعه مقفوله من قبل الطور الاساسي  ." 
end
...
if not msg.Admin then return "𖤐 **هذا الامر يخص {الادمن,المدير,المنشئ,الطور} فقط  \n" end
...
return '𖤐 اصدار سورس GENERAL : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'𖤐 ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس GENERAL يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
if not msg.Director then return "↺ **هذا الامر يخص {,المنشئ,المدير,المطور} فقط  \n↺ " end
local text = [[
...
if not msg.Director then return "𖤐 **هذا الامر يخص {الادمن,المنشئ,المدير,المطور} فقط  \n𖤐 " end
local text = [[     
↤︎❬جميع اوامر الردود ❭
————————————————
...
╭──── • ◈ • ────╮ 
么  𝑺𝑶𝑼𝑹𝑪𝑬 GENERAL 
么  [𝑨𝑺𝑲 𝑻𝑶 𝑴𝑬]  (http://t.me/Call_GeneralBot)
么  𝑫𝑬𝑽   (https://t.me/@MR_Genral)   
...
if not msg.Kara then return "𖤐 **هذا الامر يخص {المنشئ الاساسي , الاساسي} فقط ." end
...
if not msg.Kara then return "𖤐 **هذا الامر يخص {المنشئ الاساسي , الاساسي} فقط  \n" end
...
sendMsg(msg.chat_id_,msg.id_,"𖤐 تم آرسـآل رسالتك إلى GENERAL \n𖤐 سـآرد عليك في اقرب وقت ممكن \n𖤐 معرف GENERAL "..SUDO_USER)
...
sendMsg(msg.chat_id_,msg.id_,"𖤐 عذرا , عزيزي GENERAL \n𖤐 هذا ليس معرف قناة , حاول مجددا .")
return false
end
end
...
if redis:get(hack..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه 
...
if allgp >= 300 then
sendMsg(msg.chat_id_,msg.id_,'𖤐 اهلا عزيزي GENERAL \n𖤐 جاري نشر التوجيه للمجموعات وللمشتركين ...')			
end
for i = 1, #pv do 
...
elseif Text== "GENERAL" or Text== "سورس GENERAL" then return  sendMsg(msg.chat_id_,msg.id_,"[افخم سورس مصري  𖠲]")
...
elseif Text== "رفع قلبي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤐 أهلاً عزيزي\n𖤐 تم رفع العضو داخل قلبك↯\n𖤐 تمت ترقيته بنجاح\n☆")
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "موجود" then return sendMsg(msg.chat_id_,msg.id_,"امـريعيوني")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕] ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔]")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑]")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘]")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹]")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[المكان مكانك يا مطور♕]")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه]")
elseif msg.Director then 
